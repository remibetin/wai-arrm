...
## Examples of tasks for content authors

The following accessibility tasks are typically assigned to content authors as [primary owners](/planning/arrm/#primary).
